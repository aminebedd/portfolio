...
function initSectionAnimations() {
    ...
    (function() {
  emailjs.init("LlIJQHQvwNLXvVKAQ"); // ← ضع المفتاح العام من EmailJS
})();

document.getElementById("contact-form").addEventListener("submit", function(e) {
  e.preventDefault();

  emailjs.sendForm("service_e4lylir", "template_4rtv2al", this)
    .then(() => {
      alert("Dn");
    }, (error) => {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        emailjs.sendForm(
            "service_e4lylir",   // Service ID من EmailJS
            "template_4rtv2al",  // Template ID من EmailJS
            this
        ).then(
            () => {
